            ...
            <PanelContent>
                ...
                <div className={styles.CardBox}>
                    ...
                    <div className={styles.CardInbox}>
                        ...
                        <p classname="bg-[var(--btn-color)] text-gray-100 text-xs">🔝 Для продления сервера или улучшения тарифа нажмите на яркую кнопку с названием текущего тарифа справа от ID сервера.</p>
