        ...
        <div className={styles.main}>
            <div className="flex flex-col gap-4 glassb bg-active rounded-2xl p-4 mb-8">
                ...
                <ol className="list-decimal ml-8">
                    ...
                    <li>Стоимость услуг указана на <Link href="/"
                             passHref style={{color: "#0d6efd", textDecoration: "none"}}>Главной странице</Link>,
                        а также на страницах услуг.
                    </li>
                    <li>Клиенты оплачивают услуги по безналичному расчёту через
                        сторонние мерчант-сервисы «Lava» и «Ю.Касса».
                    </li>
