const orderGDPSLocale = {
    "/product/order/gd": {
        createTitle: {
            ru: "Создать новый GDPS",
            en: "Create new GDPS"
        },
        createSuccess: {
            ru: "Сервер создан",
            en: "Server succesfully created"
        },
        createFailed: {
            ru: "Не удалось создать GDPS: ",
            en: "Failed to create GDPS: "
        },
        createGDPSTitle: {
            ru: "Название",
            en: "GDPS Name"
