...
const gdSettingsLocale = {
    ...
    gdpsbot: {
        ru: [<>
            <h3>🎮 Рейт-бот для Discord</h3>
            <p>Когда игроки будут регистрироваться, загружать и рейтить уровни - вы получите красивое сообщение на сервере</p>
            <p>⚠️ Включите на канале с вебхуком разрешение "использовать внешние эмодзи с других серверов" для @everyone</p>
        </>,
            "Вебхук канала (оставьте пустым для отключения)",
            "Рейты",
            "Новые уровни",
            "Новые игроки",
            "Загрузка музыки"
        ...
        en: [<>
            <h3>🎮 Discord</h3>
            <p>Когда игроки будут регистрироваться, загружать и рейтить уровни - вы получите красивое сообщение на сервере</p>
            <p>⚠️ Enable "allow external emojis" permission on your channel for @everyone</p>
        </>,
            "Channel webhook (leave blank to disable)",
            "Rates",
            "New levels",
            "New players",
            "Music upload"
